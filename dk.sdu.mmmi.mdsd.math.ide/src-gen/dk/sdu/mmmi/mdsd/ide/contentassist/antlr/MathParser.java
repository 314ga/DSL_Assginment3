...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getExternalVarAccess().getGroup(), "rule__ExternalVar__Group__0");
			builder.put(grammarAccess.getExternalVarAccess().getGroup_3(), "rule__ExternalVar__Group_3__0");
			builder.put(grammarAccess.getExternalVarAccess().getGroup_3_1(), "rule__ExternalVar__Group_3_1__0");
			...
			builder.put(grammarAccess.getProgramAccess().getExtAssignment_2(), "rule__Program__ExtAssignment_2");
			...
			builder.put(grammarAccess.getExternalAccess().getParametersAssignment_3_0(), "rule__External__ParametersAssignment_3_0");
			builder.put(grammarAccess.getExternalAccess().getParametersAssignment_3_1_1(), "rule__External__ParametersAssignment_3_1_1");
			builder.put(grammarAccess.getExternalVarAccess().getRefAssignment_1(), "rule__ExternalVar__RefAssignment_1");
			builder.put(grammarAccess.getExternalVarAccess().getParamAssignment_3_0(), "rule__ExternalVar__ParamAssignment_3_0");
			builder.put(grammarAccess.getExternalVarAccess().getParamAssignment_3_1_1(), "rule__ExternalVar__ParamAssignment_3_1_1");
