...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MathPackage.eINSTANCE)
			...
			case MathPackage.EXTERNAL:
				...
				return; 
			case MathPackage.EXTERNAL_VAR:
				sequence_ExternalVar(context, (ExternalVar) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     ExternalVar returns ExternalVar
	 *     Exp returns ExternalVar
	 *     Exp.Plus_1_0_0_0 returns ExternalVar
	 *     Exp.Minus_1_0_1_0 returns ExternalVar
	 *     Factor returns ExternalVar
	 *     Factor.Mult_1_0_0_0 returns ExternalVar
	 *     Factor.Div_1_0_1_0 returns ExternalVar
	 *     Primary returns ExternalVar
	 *
	 * Constraint:
	 *     (ref=[External|ID] (param+=Exp param+=Exp*)?)
	 * </pre>
	 */
	protected void sequence_ExternalVar(ISerializationContext context, ExternalVar semanticObject) {
	 ...
	 *
	 * Constraint:
	 *     (name=ID ext+=External* math=MathExp)
	 * </pre>
	 */
	...
	protected void sequence_VarBinding(ISerializationContext context, VarBinding semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getVarBindingAccess().getNameIDTerminalRuleCall_2_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getVarBindingAccess().getExpressionExpParserRuleCall_4_0(), semanticObject.getExpression());
		feeder.finish();
	}
