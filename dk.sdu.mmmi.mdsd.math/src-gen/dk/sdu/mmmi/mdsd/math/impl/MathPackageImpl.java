...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   * @generated
   */
  private EClass externalVarEClass = null;
   ...
   */
  @Override
  public EReference getProgram_Ext()
  {
   ...
   */
  @Override
  public EClass getExternalVar()
  {
    return externalVarEClass;
  }
   ...
   */
  @Override
  public EReference getExternalVar_Ref()
  {
    return (EReference)externalVarEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getExternalVar_Param()
  {
    return (EReference)externalVarEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(programEClass, PROGRAM__EXT);
    ...
    externalVarEClass = createEClass(EXTERNAL_VAR);
    createEReference(externalVarEClass, EXTERNAL_VAR__REF);
    createEReference(externalVarEClass, EXTERNAL_VAR__PARAM);
  ...
  public void initializePackageContents()
  {
    ...
    externalEClass.getESuperTypes().add(this.getBinding());
    externalVarEClass.getESuperTypes().add(this.getExpression());
    ...
    initEReference(getProgram_Ext(), this.getExternal(), null, "ext", null, 0, -1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(externalVarEClass, ExternalVar.class, "ExternalVar", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getExternalVar_Ref(), this.getExternal(), null, "ref", null, 0, 1, ExternalVar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getExternalVar_Param(), this.getExpression(), null, "param", null, 0, -1, ExternalVar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
